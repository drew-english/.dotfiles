...
alias purgehostsqs="aws --profile saml sqs list-queues | grep -i \$(hostname) | xargs -I@ sh -c 'url=@; aws --profile saml sqs purge-queue --queue-url \${url%,} && echo Purged Queue: \${url%,}'"

# ZSH
alias tmx='tmux new -c ~ -A -s dev'
